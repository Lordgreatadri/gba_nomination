...
<head>
    <title>YPG Awards <?php echo date('Y'); ?> | MobileContent.com.gh </title>
                            ...
                            <div class="page-wrapper">
                                    ...
                                    <div class="row align-items-end">
                                        <div class="col-lg-8">
                                            <div class="page-header-title">
                                                <div class="d-inline">
                                                    <h4 style="color: #404e67;">PRESBYTERIAN - YPG AWARDS  <?php echo date('Y'); ?> </h4>
                                                    <br>
                                ...
                                <!-- Page-header end -->
                                    ...
                                    <div class="page-body masonry-page">
                                        ...
                                        <h5 class="m-b-20" style="font-family: Serif; font-weight: 8px; color: maroon;">CHOOSE A SUB CATEGORY YOU WISH TO VOTE FOR</h5>
                                        <div class="default-grid row">
                                            <div class="row lightboxgallery-popup">
                                                <?php
                                                    $connect->setAttribute(PDO::ATTR_AUTOCOMMIT,FALSE);
                                                    $query = "SELECT DISTINCT(category) AS cabinet FROM contestants  ORDER BY category ASC";
                                                ...
                                                <div class="col-md-3 default-grid-item">
                                                    <div class="card gallery-desc" style="border: 1px solid #404e67; border-top-left-radius: 35px; border-bottom-right-radius: 35px; border-left: 12px solid #404e67; " >
                                                        <div class="masonry-media" style="border-bottom: 1px solid #404e67;"><!-- <?php //echo $get_result["contestant_id"];?> voteidentifier -->
                                                            <a class="media-middle voter" href="category.php?q=<?php echo $value['cabinet']; ?>" >
                                                                <img class="img-fluid" src='http://mysmsinbox.com/ypg_awards/logo.png' alt='<?php echo $value["cabinet"];?>'>
                                                            </a>
                                                        </div>
                                                        <div class="card-block">
                                                            <h6 class="job-card-desc">
                                                            
                                                                <p class="text-muted1 text-info1 job-meta-data" style="color: #404e67;">
                                                            ...
                                                            <div class="job-meta-data">
                                                                <a href="category.php?q=<?php echo $value['cabinet']; ?>">                           
                                                                    <button style="background-color: #404e67 ;" id="btnsubmit" class='btn btn-sm btn-primary1 btn-block voter' data-contestant-id ='<?php //echo $value["contestant_num"];?>'  data-contestant-name ='<?php //echo $value["name"];?>' data-voteidentifier ='<?php// echo $value["category"];?>' >
                                                                        <b><span style="color: #ffffff;">Select Category</span> </b>
                                                                    </button>
                                                                </a>
                                                            </div>
                                                        </div>
