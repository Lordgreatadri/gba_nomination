		    		...
		    		<div class="row col-md-12 justify-content-center  m-2">
		    			<div class="register-form form-card col-md-6">
		    				...
		    				<form id="registrationForm">
				    			...
				    			<div class="form-cont mt-3">	
									<label for="">Top Sponsorships 3<span class="red">&#42;</span></label>
				    			...
				    			<div class="form-cont mt-1">
									...
									<input type="text" class="form-control" id="photo_link_csr"><br>
				    			</div>
				    			<div class="form-cont mt-3">	
				    			...
				    			<div class="form-cont mt-2">
									...
									<input type="text" class="form-control" id="photo_training_link"> <br>
				    			</div>
				    			<div class="form-cont mt-3">	
...
<script>
	$(document).ready(function(){
		...
		function load_submitted_data() {
            ...
            $.get("controllers/hair_brand_data.php?user="+user_value+'&category='+category, function(response) {
			    ...
			    $('#total_hair_brand_sponsored').val(response.data.total_hair_brand_sponsored);
			    $('#top_sponsorship1').val(response.data.top_sponsorship1);
			    $('#top_sponsorship2').val(response.data.top_sponsorship2);
			    $('#top_sponsorship3').val(response.data.top_sponsorship3);
			    $('#total_brand_outlet').val(response.data.total_brand_outlet);
			    $('#total_csr_events').val(response.data.total_csr_events);
			    $('#top_csr_project1').val(response.data.top_csr_project1);
			    $('#top_csr_project2').val(response.data.top_csr_project2);
			    $('#top_csr_project3').val(response.data.top_csr_project3);
			    $('#total_brand_training').val(response.data.total_brand_training);
			    $('#top_training_project1').val(response.data.top_training_project1);
			    $('#top_training_project2').val(response.data.top_training_project2);
			    $('#top_training_project3').val(response.data.top_training_project3);

			    $('#media_links').val(response.data.media_links);
			    $('#contact_lists').val(response.data.contact_lists);
			    $('#photo_link_csr').val(response.data.photo_link_csr);
			    $('#photo_training_link').val(response.data.photo_training_link);
			});	
		}
	});
</script>
...
<script>
	$(document).ready(function(){
        $("#registrationForm").submit(function(event) {
            ...
            $.ajax({
                url: "controllers/hair_brand_record_update.php",
                type: "POST",
                data: {
                    nominee_name,
	             	user_value,
