		    			...
		    			<div class="register-form form-card col-md-6">
		    				...
		    				<form id="registrationForm">
			    				...
			    				<div class="form-cont mt-5">	
				    			  ...
				    			  <select class="form-control"  name="category" id="category" required disabled readonly>
				    			...
				    			<div class="form-cont mt-5">
									...
									<input type="text" class="form-control" id="photo_link_editorial"><br>
				    			</div>
				    			<div class="form-cont mt-5">
				    			...
				    			<div class="form-cont mt-1">
									...
									<input type="text" class="form-control" id="photo_link_bridal"> <br>
				    			</div>
...
<script>
	$(document).ready(function(){
		...
		function load_submitted_data() {
            ...
            $.get("controllers/photographer_data.php?user="+user_value+'&category='+category, function(response) {
			    ...
			    $('#editorial_photo_description1').val(response.data.editorial_photo_description1);
			    $('#editorial_photo_description2').val(response.data.editorial_photo_description2);
			    $('#bridal_photo_description1').val(response.data.bridal_photo_description1);
			    $('#bridal_photo_description2').val(response.data.bridal_photo_description2);
			    $('#photo_link_editorial').val(response.data.photo_link_editorial);
			    $('#photo_link_bridal').val(response.data.photo_link_bridal);
			});	
		}
	});
</script>
...
<script>
	$(document).ready(function(){
        $("#registrationForm").submit(function(event) {
            ...
            $.ajax({
                url: "controllers/photographer_record_update.php",
                type: "POST",
                data: {
                    nominee_name,
	             	user_value,
