		    			...
		    			<div class="register-form form-card col-md-6">
		    				...
		    				<form id="registrationForm">
				    			...
				    			<div class="form-cont mt-5">	
				    			  <label for="">
				    			  	<h3><b>Best Hair Colorist of the Year</b></h3> 
				    			  	<br>
				    			  	<label>This category seeks to reward the most versatile and dynamic hair colorist.</label>
								</label>									
				    			</div>
			    				...
			    				<div class="form-cont mt-3">	
				    			  ...
				    			  <select class="form-control"  name="category" id="category" required disabled="true">
				    			  	<option value="Best Hair Colorist of the Year">Best Hair Colorist of the Year</option>
