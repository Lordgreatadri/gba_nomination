		    			...
		    			<div class="register-form form-card col-md-6">
		    				...
		    				<form id="registrationForm">
				    			...
				    			<div class="form-cont mt-5">	
				    			  <label for="">
				    			  	<h3><b>Most Promising Makeup Artist</b></h3> </label>
				    			  	<label>The<b> Most Promising Makeup Artist</b> category seeks to find the best new makeup artist who shows the most promise for exceptional work mixed with innovativation within the industry.</label>
				    			  	<ul>
										<li>Must be less than 3 years in the industry</li>										
										<li>Must be creative, artistic and innovative</li>
										<li>Must have good customer service</li>
			    				...
			    				<div class="form-cont mt-3">	
				    			  ...
				    			  <select class="form-control"  name="category" id="category" required disabled="true">
									   <option value="Most Promising Makeup Artist">Most Promising Makeup Artist</option>
				    			...
				    			<hr>
				    			<div class="form-cont mt-5">
				    			<label><b>Most Promising Artist: Project 1</b></label>	<br>
				    			  <label for="">Description - Most Promising: Project 1 <span class="red">&#42;</span></label>
				    			  <textarea class="form-control" id="promising_project1" name="promising_project1" placeholder="" required></textarea> 
				    			</div>

				    			<div class="form-cont mt-1">
				    			<label><b>Most Promising Artist: Project 2</b></label>	<br>
				    			  <label for="">Description - Most Promising: Project 2 <span class="red">&#42;</span></label>
				    			  <textarea class="form-control" id="promising_project2" name="promising_project2" placeholder="" required></textarea> 
				    			</div>
				    			<div class="form-cont mt-1">
				    			<label><b>Most Promising Artist: Project 3</b></label>	<br>
				    			  <label for="">Description - Most Promising: Project 3 <span class="red">&#42;</span></label>
				    			  <textarea class="form-control" id="promising_project3" name="promising_project3" placeholder="" required></textarea> 
				    			</div>
...
<script>
	$(document).ready(function(){
        $("#registrationForm").submit(function(event) {
            ...
            var bridal_project_description1 = $("#promising_project1").val();
            var bridal_project_description2 = $("#promising_project2").val();
            var bridal_project_description3 = $("#promising_project3").val();
