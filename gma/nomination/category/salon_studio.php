		    			...
		    			<div class="register-form form-card col-md-6">
		    				...
		    				<form id="registrationForm">
				    			...
				    			<div class="form-cont mt-5">	
				    			  <label for="">
				    			  	<h3><b>Best Salon/Studio</b></h3> 
				    			  	<br>
				    			  	<label>This seeks to celebrate the best salon or makeup studio in the country that demonstrates top-notch service and ‘stands-out’ in all area of salon or studio business.</label>
								</label>								
								<br>
				    			...
				    			<div class="form-cont mt-5">	
				    			  <label style="diplay: inline" for="">Details about the salon being nominated for this category <!-- <span class="red">&#42;</span> --></label>
				    			  <input class="form-control" type="text" id="company_details" placeholder="salon name" />
				    			</div>

				    			<div class="form-cont mt-1">	
				    			  <label style="diplay: inline" for="">Short Salon Profile </label>
				    			  <!-- <input class="form-control" type="text" id="last_name" placeholder="first name" /> -->
				    			  <textarea class="form-control"  name="comapny_bio" id="comapny_bio" placeholder="100 word limit 0/100" ></textarea>
				    			</div>

				    			<div class="form-cont mt-1">	
				    			  <label style="diplay: inline" for="">Salon's Instagram Account  </label>
				    			  <input class="form-control" type="text" id="company_instagram" name="company_instagram" placeholder="eg. makeupghana" />
				    			</div>

				    			<div class="form-cont mt-1">	
				    			  <label style="diplay: inline" for="">Salon's Facebook Account </label>
				    		...
				    		<div style="display: none;">
				    			<div class="form-cont mt-5">	
				    			  ...
				    			  <input class="form-control" type="text" id="company_name" name="company_name" placeholder="salon name" />
				    			</div>

				    			<div class="form-cont mt-1">	
				    			  <label for="">Salon's Contact Number <span class="red">&#42;</span></label>
				    			  <input class="form-control" type="text" id="phone_number" name="phone_number" placeholder="contact number" />
				    			</div>

				    			<div class="form-cont mt-1">	
				    			  <label for="">Salon's E-mail<span class="red">&#42;</span></label>
