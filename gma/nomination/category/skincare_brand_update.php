		    		...
		    		<div class="row col-md-12 justify-content-center  m-2">
		    			<div class="register-form form-card col-md-6">
		    				...
		    				<form id="registrationForm">
				    			...
				    			<div class="form-cont mt-1">	
									<label for=""><b>Distribution Network</b></label><br>
...
<script>
	$(document).ready(function(){
		...
		function load_submitted_data() {
            ...
            $.get("controllers/skincare_data.php?user="+user_value+'&category='+category, function(response) {
			    ...
			    $('#skincare_product_comment').val(response.data.skincare_product_comment);
			    $('#skincare_total_outlets').val(response.data.skincare_total_outlets);
			});	
		}
	});
</script>
...
<script>
	$(document).ready(function(){
        $("#registrationForm").submit(function(event) {
            ...
            $.ajax({
                url: "controllers/skincare_record_update.php",
                type: "POST",
                data: {
                    nominee_name,
	             	user_value,
