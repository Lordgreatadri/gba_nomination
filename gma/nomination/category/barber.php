		    			...
		    			<div class="register-form form-card col-md-6">
		    				...
		    				<form id="registrationForm">
				    			...
				    			<div class="form-cont mt-5">	
				    			  <label for="">
				    			  	<h3><b>Barber of the Year</b></h3> 
				    			  	<br>
				    			  	<label>This category seeks to reward a top-notch men’s hair and barbering expert who has demonstrated creativity and innovation.</label>
								</label>									
				    			</div>
