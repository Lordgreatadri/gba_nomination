		    			...
		    			<div class="register-form form-card col-md-6">
		    				...
		    				<form id="registrationForm">
				    			...
				    			<div class="form-cont mt-5">	
				    			  <label for="">
				    			  	<h3><b>Nail Technician of the Year</b></h3> 				    			  	
								</label>	
								<label>The <b> Nail Technician of the Year</b> category seeks to find a nail specialist who has demonstrated a high level of art and skill in nail techniques.</label>								
				    			</div>
