		    			...
		    			<div class="register-form form-card col-md-6">
		    				...
		    				<form id="registrationForm">
				    			...
				    			<div class="form-cont mt-5">	
				    			  <label for="">
				    			  	<h3><b>Spa and Wellness Center</b></h3> 
				    			  	<br>
				    			  	<label>This seeks to celebrate the best spa and wellness centers in the country that demonstrates top-notch service and ‘stand-out’ in all area of spa and wellness business.</label>
								</label>	
								<br>
				    			...
				    			<div class="form-cont mt-5">	
				    			  <label style="diplay: inline" for="">Details about the spa being nominated for this category<!--  <span class="red">&#42;</span> --></label>
				    			  <input class="form-control" type="text" id="company_details" placeholder="spa name" />
				    			</div>

				    			<div class="form-cont mt-1">	
				    			  <label style="diplay: inline" for="">Short Spa Profile </label>
				    			  <!-- <input class="form-control" type="text" id="last_name" placeholder="first name" /> -->
				    			  <textarea class="form-control"  name="comapny_bio" id="comapny_bio" placeholder="100 word limit 0/100" ></textarea>
				    			</div>

				    			<div class="form-cont mt-1">	
				    			  <label style="diplay: inline" for="">Spa's Instagram Account  </label>
				    			  <input class="form-control" type="text" id="company_instagram" name="company_instagram" placeholder="eg. makeupghana" />
				    			</div>

				    			<div class="form-cont mt-1">	
				    			  <label style="diplay: inline" for="">Spa's Facebook Account </label>
				    		...
				    		<div style="display: none;">
				    			<div class="form-cont mt-5">	
				    			  ...
				    			  <input class="form-control" type="text" id="company_name" name="company_name" placeholder="spa name" />
				    			</div>

				    			<div class="form-cont mt-1">	
				    			  <label for="">Spa's Contact Number <span class="red">&#42;</span></label>
				    			  <input class="form-control" type="text" id="phone_number" name="phone_number" placeholder="contact number" />
				    			</div>

				    			<div class="form-cont mt-1">	
				    			  <label for="">Spa's E-mail<span class="red">&#42;</span></label>
