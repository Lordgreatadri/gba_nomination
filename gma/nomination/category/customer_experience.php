		    			...
		    			<div class="register-form form-card col-md-6">
		    				...
		    				<form id="registrationForm">
				    			...
				    			<div class="form-cont mt-5">	
				    			  <label for="">
				    			  	<h3><b>Best Customer Service Experience</b></h3> 
				    			  	<br>
				    			  	<label>This category celebrates to find the beauty brand with quality and professional finest customer service.</label>
								</label>									
				    			</div>
			    				...
			    				<div class="form-cont mt-3">	
				    			  ...
				    			  <select class="form-control"  name="category" id="category" required disabled="true">
									   <option value="Best Customer Service Experience">Best Customer Service Experience</option>
