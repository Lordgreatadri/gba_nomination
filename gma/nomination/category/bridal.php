		    			...
		    			<div class="register-form form-card col-md-6">
		    				...
		    				<form id="registrationForm">
				    			...
				    			<div class="form-cont mt-5">	
				    			  <label for="">
				    			  	<h3><b>Best Bridal Makeup Artist</b></h3> 
				    			  	The <b>Best Bridal Makeup Artist </b>category seeks to reward the best makeup artist for the use of makeup in a bridal context.
									<ul>
										<li>Must be creative and artistic</li>										
										<li>Must enhance the beauty of the bride</li>
...
<script>
	$(document).ready(function(){
        $("#registrationForm").submit(function(event) {
            ...
            $.ajax({
                url: "controllers/bridal_entry.php",
                type: "POST",
                data: {
                	user_value,
                    first_name,
                ...
                beforeSend: function() {
                    // $("#registrationForm").trigger('reset'); bridal_update.php?user='+user_value+'&category='+category
                },
