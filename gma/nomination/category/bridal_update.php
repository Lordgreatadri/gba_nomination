		    		...
		    		<div class="row col-md-12 justify-content-center  m-2">
		    			<div class="register-form form-card col-md-6">
		    				...
		    				<form id="registrationForm">
				    			...
				    			<div class="form-cont mt-5">
				    				<h5><b>Bridal: Project 1</b></h5>
				    				<label>Provide Link to Pictures of Bridal Project 1 <span class="red">&#42;</span></label>
				    			...
				    			<div class="form-cont mt-1">	
									...
									<label for="">Description - Bridal Project 1 <span class="red">&#42;</span> </label>
				    			  <textarea  class="form-control"  id="bridal_project_description1" name="bridal_project_description1" placeholder="" ></textarea>
				    			</div>

				    			<div class="form-cont mt-3">
				    				<h5><b>Bridal: Project 2</b></h5>
				    				<label>Provide Link to Pictures of Bridal Project 2 <span class="red">&#42;</span></label>
									<input type="text" class="form-control" id="photo_link2">
									<label><small><i>Please upload pictures of this project to any platform and share the link(e.i dropbox, google drive, wetransfare or social media etc.)</i></small></label> <br>
				    			</div>
				    			<div class="form-cont mt-1">	
				    				
				    			  	<label for="">Description - Bridal Project 2 <span class="red">&#42;</span></label>
				    			  	<textarea class="form-control"  name="bridal_project_description2" id="bridal_project_description2" placeholder="" ></textarea>
				    			  	<label for=""><small><i>Please describe and provide context for this project</i></small></label>
				    			</div>

				    			<div class="form-cont mt-3">
				    				<h5><b>Bridal: Project 3</b></h5>
				    				<label>Provide Link to Pictures of Bridal Project 3 <span class="red">&#42;</span></label>
									<input type="text" class="form-control" id="photo_link3">
									<label><small><i>Please upload pictures of this project to any platform and share the link(e.i dropbox, google drive, wetransfare or social media etc.)</i></small></label> <br>
				    			</div>
				    			<div class="form-cont mt-1">	
				    				
				    			  	<label for="">Description - Bridal Project 3 <span class="red">&#42;</span></label>
				    			  	<textarea class="form-control"  name="bridal_project_description3" id="bridal_project_description3" placeholder="" ></textarea>
				    			  	<label for=""><small><i>Please describe and provide context for this project</i></small></label>
				    			</div>
...
<script>
	$(document).ready(function(){
		...
		function load_submitted_data() {
            ...
            $.get("controllers/bridal_data.php?user="+user_value+'&category='+category, function(response) {
			    ...
			    $('#photo_link1').val(response.data.photo_link1);
			    $('#bridal_project_description1').val(response.data.bridal_project_description1);
			    $('#photo_link2').val(response.data.photo_link2);
			    $('#bridal_project_description2').val(response.data.bridal_project_description2);
			    $('#photo_link3').val(response.data.photo_link3);
			    $('#bridal_project_description3').val(response.data.bridal_project_description3);
			    // $('#editorial_project_description2').val(response.data.editorial_project_description2);
			    // $('#editorial_project_name3').val(response.data.editorial_project_name3);
			    // $('#editorial_project_description3').val(response.data.editorial_project_description3);
			});	
		}
	});
</script>
...
<script>
	$(document).ready(function(){
        $("#registrationForm").submit(function(event) {
            ...
            var bridal_project_description2 = $("#bridal_project_description2").val();
            var photo_link2 = $("#photo_link2").val();
            var bridal_project_description1 = $("#bridal_project_description1").val();
            var photo_link3 = $("#photo_link3").val();
            var bridal_project_description3 = $("#bridal_project_description3").val();
            ...
            $.ajax({
                url: "controllers/ebridal_record_update.php",
                type: "POST",
                data: {
                    nominee_name,
	             	user_value,
	            	...
	            	photo_link1,
	            	bridal_project_description2,
	             	photo_link2,
	             	bridal_project_description1,
	            	photo_link3,
	             	bridal_project_description3 
                },
                beforeSend: function() {
