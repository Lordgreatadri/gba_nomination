		    			...
		    			<div class="register-form form-card col-md-6">
				    		...
				    		<div style="display: none;">
				    			...
				    			<div class="form-cont mt-3" style="diplay: inline-block">	
				    				...
				    				<a href="../register.html"  class="btn btn-info mt-3 float-left">Cancel</a>&nbsp;&nbsp;
				    			</div>
...
<script>
	$(document).ready(function(){
		...
		function load_submitted_data() {
            ...
            $.get("controllers/makeup_artist_data.php?user="+user_value+'&category='+category, function(response) {
			    ...
			    $('#makeupart_description1').val(response.data.makeupart_description1);
			    $('#photo_link2').val(response.data.photo_link2);
			    $('#makeupart_description2').val(response.data.makeupart_description2);
			    $('#photo_editorial_link1').val(response.data.photo_editorial_link1);
			    $('#editorial_description1').val(response.data.editorial_description1);
			    $('#photo_editorial_link2').val(response.data.photo_editorial_link2);
			    $('#editorial_description2').val(response.data.editorial_description2);
			    $('#photo_bridal_link1').val(response.data.photo_bridal_link1);
			    $('#bridal_work_description1').val(response.data.bridal_work_description1);
			    $('#photo_bridal_link2').val(response.data.photo_bridal_link2);
			    $('#bridal_work_description2').val(response.data.bridal_work_description2);
			});	
		}
	});
</script>
...
<script>
	$(document).ready(function(){
        $("#registrationForm").submit(function(event) {
            ...
            $.ajax({
                url: "controllers/makeup_artist_record_update.php",
                type: "POST",
                data: {
                    nominee_name,
	             	user_value,
