		    			...
		    			<div class="register-form form-card col-md-6">
		    				...
		    				<form id="registrationForm">
				    			...
				    			<div class="form-cont mt-5">	
				    			  <label for="">
				    			  	<h3><b>Hairstylist of the Year</b></h3> 
				    			  	The <b>Hairstylist of the Year</b> category seeks to reward a hair stylist who has demonstrated a high level of art and skill in all aspects of hairstyling. <br><br>
									<ul>
										<label>The Hair Stylist must demonstrate skill and exceptional artistry in the following hair styling categories;</label>
