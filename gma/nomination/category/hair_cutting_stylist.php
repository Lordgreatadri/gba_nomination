		    			...
		    			<div class="register-form form-card col-md-6">
		    				...
		    				<form id="registrationForm">
				    			...
				    			<div class="form-cont mt-5">	
				    			  <label for="">
				    			  	<h3><b>Hair Cutting Stylist</b></h3> 
				    			  	The <b>Hair Cutting Stylist</b> category seeks to reward the most versatile and dynamic hair cutting stylist.
									<ul>
										<li>This category is open to all hair cutting stylists</li>
										<!-- <li>Hair cutting stylists must demonstrate skill and exceptional artistry in the following hair styling categories</li>
			    				...
			    				<div class="form-cont mt-3">	
				    			  ...
				    			  <select class="form-control"  name="category" id="category" required disabled="true">
									   <option value="Hair Cutting Stylist">Hair Cutting Stylist</option>
