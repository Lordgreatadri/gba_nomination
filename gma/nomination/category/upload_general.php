...
<!-- <hr> -->
				    			<div class="form-cont mt-2" style="display: inline;">
				    				<label style="background: #F4EFEE; padding: 2px;">Hello <b>'<?php echo $user_name; ?>'</b>; here you are to upload picture of Proof of Business Registration and 3 pictures of your best projects/work/events in (<span class="text-danger">jpeg, jpg, png</span>) formats only </label> <br><br>
				    				<label>Choose Photos <span class="red">&#42;</span></label>
				    				<div style="background-color: transparent;" class="col-md-12">
					                    <div class="input-group mb-3">
					                      <input id="files" type="file" name="files" id="files[]" class="form-control " placeholder="Add Photo of project" multiple required>
					                      <label><small><i>You can select multiple images at ago and click Submit Files <b>only once and relax for upload</b></i></small></label>
					                    </div>
					                </div>
				    			</div>
				    			...
				    			<button id="submit"  class="btn btn-primary mt-3 float-right">Submit Files Once</button>
			    		...
			    		<div class="col-md-10 justify-content-center m-2 ">
			    			...
			    			<label id="message" class="text-center text-success alert alert-success col-md-10 text-center" role="alert" style="display: none;"> <b>Your files uploaded successfully. Please check your email for alert or sms on your phone for receipt of you nomination. Thank you</b></label>
