...
// Upload directory
$upload_location = "uploads/non_bussiness/";
   ...
   if(isset($_FILES['files']['name'][$index]) && $_FILES['files']['name'][$index] != ''){
      ...
      if(in_array($ext, $valid_ext)){
         ...
         if(move_uploaded_file($_FILES['files']['tmp_name'][$index],$path)){
            $files_arr[] = $path;
            $insertImageDetailsQuery = "INSERT INTO  upload_photo_non_bussiness( user_name, user_value, category, project_photo_url) VALUES('$user_name', '$user_vallue', '$category', '$filedirectory')";
