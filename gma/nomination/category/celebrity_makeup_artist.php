		    			...
		    			<div class="register-form form-card col-md-6">
		    				...
		    				<form id="registrationForm">
		    					<div class="form-cont mt-5">	
				    			    <label for="">
					    			  	<h3><b>Celebrity Makeup Artist of the Year</b></h3> 
					    			  	The<b> Best Celebrity Makeup Artist </b>category seeks to find the best makeup artist for the use of makeup in a public figure or celebrity context.
										<ul>
											<li>Must be creative and artistic</li>										
											<li>Must have worked on multiple celebrities or public figures.</li>
											<li>Must have a strong social media presence</li>
			    				...
			    				<div class="form-cont mt-3">	
				    			  ...
				    			  <select class="form-control"  name="category" id="category" required disabled="true">
									   <option value="Celebrity Makeup Artist of the Year">Celebrity Makeup Artist of the Year</option>
				    			...
				    			<div class="form-cont mt-5">	
				    				<h5><b>Celebrity Makeup Artist: Project 1</b></h5>									
									<label for="">Description - Celebrity Artist: Project 1 <span class="red">&#42;</span> </label>
				    			  <textarea  class="form-control"  id="celebrity_project_description1" name="celebrity_project_description1" placeholder="" required ></textarea>
				    			</div>

				    			<div class="form-cont mt-1">
				    			<h5><b>Celebrity Makeup Artist: Project 2</b></h5>										
									<label for="">Description - Celebrity Artist: Project 2 <span class="red">&#42;</span> </label>
				    			  <textarea  class="form-control"  id="celebrity_project_description2" name="celebrity_project_description2" placeholder="" required></textarea>
				    			</div>
				    			<div class="form-cont mt-1">	
				    				<h5><b>Celebrity Makeup Artist: Project 3</b></h5>									
									<label for="">Description - Celebrity Artist: Project 3 <span class="red">&#42;</span> </label>
				    			  <textarea  class="form-control"  id="celebrity_project_description3" name="celebrity_project_description3" placeholder="" ></textarea>
				    			</div>
...
<script>
	$(document).ready(function(){
        $("#registrationForm").submit(function(event) {
            ...
            var bridal_project_description1 = $("#celebrity_project_description1").val();
            var bridal_project_description2 = $("#celebrity_project_description2").val();
            var bridal_project_description3 = $("#celebrity_project_description3").val();
            ...
            $.ajax({
                ...
                success:function(response){
                	if (response.success == true) {
                		...
                		window.location.href = 'bridal_update.php?user='+user_value+'&category='+category;
                	}else{
                		console.log(response);
                		alert(response.message);
                	}
