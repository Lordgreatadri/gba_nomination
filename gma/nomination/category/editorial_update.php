		    			...
		    			<div class="register-form form-card col-md-6">
		    				...
		    				<form id="registrationForm">
		    					<div class="form-cont mt-3">	
				    			  <label for="">
				    			  	<h4><b>Best Editorial Makeup Artist</b></h4> 
								</label>
...
<script>
	$(document).ready(function(){
		...
		function load_submitted_data() {
            ...
            $.get("controllers/editorial_data.php?user="+user_value+'&category='+category, function(response) {
			    ...
			    $('#editorial_project_name1').val(response.data.editorial_project_name1);
			    $('#editorial_project_description1').val(response.data.editorial_project_description1);
			    $('#editorial_project_name2').val(response.data.editorial_project_name2);
...
<script>
	$(document).ready(function(){
        $("#registrationForm").submit(function(event) {
            ...
            $.ajax({
                url: "controllers/editorial_record_update.php",
                type: "POST",
                data: {
                    nominee_name,
	             	user_value,
