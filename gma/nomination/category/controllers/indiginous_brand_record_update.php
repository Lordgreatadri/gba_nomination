...
if($_SERVER['REQUEST_METHOD'] == 'POST') 
{
	...
	// {
		$result = $data_Obj->update_indiginous_brand($user_value, $category, $nominee_name, $email, $mobile_number, $nominee_bio, $instagram, $facebook, $other, $company_details, $comapny_bio, $company_instagram, $company_facebook, $company_other, $company_name, $phone_number, $company_email, $total_indiginous_product_sponsored, $ghanaian_sponsorship1, $ghanaian_sponsorship2, $ghanaian_sponsorship3, $total_indiginous_outlet, $total_indiginous_csr_projects, $ghanaian_top_csr_project1, $ghanaian_top_csr_project2 ,$ghanaian_top_csr_project3 ,$total_indiginous_training ,$ghanaian_top_training_project1 ,$ghanaian_top_training_project2, $ghanaian_top_training_project3, $media_links, $photo_link_csr, $photo_link_events);
