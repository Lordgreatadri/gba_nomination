...
if($_SERVER['REQUEST_METHOD'] == 'POST') 
{
	...
	{
		$result = $data_Obj->save_television_nomination($user_value, $category, $nominee_name, $email, $mobile_number, $nominee_bio, $instagram, $facebook, $other, $company_details, $comapny_bio, $company_instagram, $company_facebook, $company_other, $company_name, $phone_number, $company_email, $tvstation_name, $website_url, $tvstation_video, $tvstation_video_description, $tvstation_video2, $tvstation_video_description2, $tvstation_video3, $tvstation_video_description3 ,$tvstation_video4 ,$tvstation_video_description4 ,$tvstation_video5 ,$tvstation_video_description5);
