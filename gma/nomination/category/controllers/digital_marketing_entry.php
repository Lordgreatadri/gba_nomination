...
if($_SERVER['REQUEST_METHOD'] == 'POST') 
{
	...
	{
		$result = $data_Obj->save_digital_marketing_nomination($user_value, $category, $nominee_name, $email, $mobile_number, $nominee_bio, $instagram, $facebook, $other, $company_details, $comapny_bio, $company_instagram, $company_facebook, $company_other, $company_name, $phone_number, $company_email, $midea_category_list, $digital_campaign_summmary, $digital_insight, $digital_big_idea, $digital_execution, $digital_results);
