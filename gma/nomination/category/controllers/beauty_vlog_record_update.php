...
if($_SERVER['REQUEST_METHOD'] == 'POST') 
{
	...
	// {
		$result = $data_Obj-> update_beauty_vlog($user_value, $category, $nominee_name, $email, $mobile_number, $nominee_bio, $instagram, $facebook, $other, $company_details, $comapny_bio, $company_instagram, $company_facebook, $company_other, $company_name, $phone_number, $company_email, $vlog_name, $vlog_url, $vlog_cat1_post1, $vlog_cat1_post2, $vlog_cat2_post1, $vlog_cat2_post2, $vlog_cat3_post1, $vlog_cat3_post2 ,$vlog_cat4_post1 ,$vlog_cat4_post2 ,$vlog_engagement_post1 ,$vlog_engagement_post2, $vlog_engagement_post3);
