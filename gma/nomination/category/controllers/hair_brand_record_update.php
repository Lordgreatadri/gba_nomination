...
if($_SERVER['REQUEST_METHOD'] == 'POST') 
{
	...
	// {
		$result = $data_Obj->update_hair_brand($user_value, $category, $nominee_name, $email, $mobile_number, $nominee_bio, $instagram, $facebook, $other, $company_details, $comapny_bio, $company_instagram, $company_facebook, $company_other, $company_name, $phone_number, $company_email, $total_hair_brand_sponsored, $top_sponsorship1, $top_sponsorship2, $top_sponsorship3, $total_brand_outlet, $total_csr_events, $top_csr_project1, $top_csr_project2 ,$top_csr_project3 ,$total_brand_training ,$top_training_project1 ,$top_training_project2, $top_training_project3, $media_links, $contact_lists, $photo_link_csr, $photo_training_link);
