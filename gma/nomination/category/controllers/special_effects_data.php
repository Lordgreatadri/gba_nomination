...
if($_SERVER['REQUEST_METHOD'] == 'GET') 
{
	...
	foreach ($data_Obj->load_submitted_record("special_effects", $user_value, $category) as $value) {
		...
		$special_effect_link = $value['special_effect_link']; 
		$special_effect_print = $value['special_effect_print']; 
		$theatre_link = $value['theatre_link']; 
		$theatre_description = $value['theatre_description'];
		$social_media_link = $value['social_media_link'];  
		$social_media_description = $value['social_media_description'];
	}
    ...
    $statsArray["photo_link"] = $photo_link;
    $statsArray["photo_description"] = $photo_description;
    $statsArray["special_effect_link"] = $special_effect_link;
    $statsArray["special_effect_print"] = $special_effect_print;
    $statsArray["theatre_link"] = $theatre_link;
    $statsArray["theatre_description"] = $theatre_description;
    $statsArray["social_media_link"] = $social_media_link;
    $statsArray["social_media_description"] = $social_media_description;
