...
if($_SERVER['REQUEST_METHOD'] == 'GET') 
{
	...
	$nominee_name = "";
	 $email = "";
	$mobile_number = ""; $nominee_bio = ""; $instagram = ""; $facebook = ""; $other = "";  $company_details = ""; $comapny_bio = ""; $company_instagram = ""; $company_facebook = ""; $company_other = ""; $company_name = ""; $phone_number = ""; $company_email = ""; $midea_category_list = ""; $digital_campaign_summmary = ""; $digital_insight = ""; 
	$digital_big_idea = "";

	foreach ($data_Obj->load_submitted_record("digital_marketing", $user_value, $category) as $value) {
		...
		$midea_category_list = $value['midea_category_list']; 
		$digital_campaign_summmary = $value['digital_campaign_summmary']; 
		$digital_insight = $value['digital_insight']; 
		$digital_big_idea = $value['digital_big_idea'];
		$digital_execution = $value['digital_execution'];
		$digital_results = $value['digital_results'];
	}
    ...
    $statsArray["midea_category_list"] = $midea_category_list;
    $statsArray["digital_campaign_summmary"] = $digital_campaign_summmary;
    $statsArray["digital_insight"] = $digital_insight;
    $statsArray["digital_big_idea"] = $digital_big_idea;
    $statsArray["digital_execution"] = $digital_execution;
    $statsArray["digital_results"] = $digital_results;
