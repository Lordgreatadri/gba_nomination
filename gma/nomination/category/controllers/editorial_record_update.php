...
if($_SERVER['REQUEST_METHOD'] == 'POST') 
{
	...
	// {
		$result = $data_Obj->update_editorial($user_value, $category, $nominee_name, $email, $mobile_number, $nominee_bio, $instagram, $facebook, $other, $company_details, $comapny_bio, $company_instagram, $company_facebook, $company_other, $company_name, $phone_number, $company_email, $editorial_project_name1, $photo_link1, $editorial_project_description1, $editorial_project_name2, $photo_link2, $editorial_project_description2, $editorial_project_name3, $photo_link3, $editorial_project_description3);
