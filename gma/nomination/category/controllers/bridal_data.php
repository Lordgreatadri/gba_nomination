...
if($_SERVER['REQUEST_METHOD'] == 'GET') 
{
	...
	foreach ($data_Obj->load_submitted_record("bridal_makeup_artist", $user_value, $category) as $value) {
		...
		$bridal_project_description1 = $value['bridal_project_description1']; 
		$photo_link2 = $value['photo_link2'];
		$bridal_project_description2 = $value['bridal_project_description2']; 
		$photo_link3 = $value['photo_link3'];
		$bridal_project_description3 = $value['bridal_project_description3']; 
    ...
    $statsArray["bridal_project_description1"] = $bridal_project_description1;
    $statsArray["bridal_project_description2"] = $bridal_project_description2;
    $statsArray["bridal_project_description3"] = $bridal_project_description3;
