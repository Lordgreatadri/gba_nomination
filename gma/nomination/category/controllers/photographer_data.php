...
if($_SERVER['REQUEST_METHOD'] == 'GET') 
{
	...
	foreach ($data_Obj->load_submitted_record("photographer", $user_value, $category) as $value) {
		...
		$photo_link_editorial  = $value['photo_link_editorial']; 
		$photo_link_bridal  = $value['photo_link_bridal'];
		$editorial_photo_description1 = $value['editorial_photo_description1']; 
		$editorial_photo_description2 = $value['editorial_photo_description2']; 
		$bridal_photo_description1 = $value['bridal_photo_description1']; 
		$bridal_photo_description2 = $value['bridal_photo_description2']; 
    ...
    $statsArray["photo_link_editorial"] = $photo_link_editorial;
    $statsArray["photo_link_bridal"] = $photo_link_bridal;
    $statsArray["editorial_photo_description1"] = $editorial_photo_description1;
    $statsArray["editorial_photo_description2"] = $editorial_photo_description2;
    $statsArray["bridal_photo_description1"] = $bridal_photo_description1;
    $statsArray["bridal_photo_description2"] = $bridal_photo_description2;
