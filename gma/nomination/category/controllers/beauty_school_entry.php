...
if($_SERVER['REQUEST_METHOD'] == 'POST') 
{
	...
	{
		$result = $data_Obj->save_beauty_school_nomination($user_value, $category, $nominee_name, $email, $mobile_number, $nominee_bio, $instagram, $facebook, $other, $company_details, $comapny_bio, $company_instagram, $company_facebook, $company_other, $company_name, $phone_number, $company_email,			$total_graduants, $graduant_2017_name1, $graduant_2017_email1, $graduant_2017_phone1, $accomplishment1_2017, $graduant_2017_name2, $graduant_2017_email2, $graduant_2017_phone2 ,$accomplishment2_2017 ,$graduant_2017_name3 ,$graduant_2017_email3 ,$graduant_2017_phone3, $accomplishment3_2017);
