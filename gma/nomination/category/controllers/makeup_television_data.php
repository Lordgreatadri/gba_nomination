...
if($_SERVER['REQUEST_METHOD'] == 'GET') 
{
	...
	foreach ($data_Obj->load_submitted_record("makeup_television", $user_value, $category) as $value) {
		...
		$tvstation_name = $value['tvstation_name']; 
		$website_url = $value['website_url']; 
		$tvstation_video = $value['tvstation_video']; 
		$tvstation_video_description = $value['tvstation_video_description'];
		$tvstation_video2 = $value['tvstation_video2'];
		$tvstation_video_description2 = $value['tvstation_video_description2'];
		$tvstation_video3 = $value['tvstation_video3']; 
		$tvstation_video_description3 = $value['tvstation_video_description3']; 
		$tvstation_video4 = $value['tvstation_video4']; 
		$tvstation_video_description4 = $value['tvstation_video_description4'];
		$tvstation_video5 = $value['tvstation_video5'];
		$tvstation_video_description5 = $value['tvstation_video_description5'];
    ...
    $statsArray["tvstation_name"] = $tvstation_name;
    $statsArray["website_url"] = $website_url;
    $statsArray["tvstation_video"] = $tvstation_video;
    $statsArray["tvstation_video_description"] = $tvstation_video_description;
    $statsArray["tvstation_video2"] = $tvstation_video2;
    $statsArray["tvstation_video_description2"] = $tvstation_video_description2;
    $statsArray["tvstation_video3"] = $tvstation_video3;
    $statsArray["tvstation_video_description3"] = $tvstation_video_description3;
    $statsArray["tvstation_video4"] = $tvstation_video4;
    $statsArray["tvstation_video_description4"] = $tvstation_video_description4;
    $statsArray["tvstation_video5"] = $tvstation_video5;
    $statsArray["tvstation_video_description5"] = $tvstation_video_description5;
