		    			...
		    			<div class="register-form form-card col-md-6">
		    				...
		    				<form id="registrationForm">
				    			...
				    			<div class="form-cont mt-5">	
				    			  <label for="">
				    			  	<h3><b>Beauty Entrepreneur of the Year</b></h3> 
				    			  	<br>
				    			  	<label>This category seeks to recognize the achievements of an individual that has contributed to the economic growth of the industry.</label>
								</label>	

									<ul>
										<li>An Established Online Presence</li>
										<li>A High Level of Professionalism </li>
										<li>Societal impact and commitment to building a values-based company</li>
										<li>Innovative and be able to manage talents</li>
										<li>Submissions of the Contacts of Top 3 Employees</li>
									</ul>								
				    			</div>
				    		...
				    		<div style="display: none;">
				    			...
				    			<div class="form-cont mt-5">
				    				...
				    				<label>Submissions of the Contacts of Top 3 Employees</label>
				    			</div>
